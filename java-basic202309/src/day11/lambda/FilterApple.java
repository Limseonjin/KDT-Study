...
public class FilterApple {
    ...
    *  @problem - 만약 다른 색깔의 사과를 필터링 해야한다면? - 새로운 메서드를 생성해야함
    ...
    *           - 함수를 전달받을 수 있다면? -> 자바는 함수를 전달할 수 없다.
    *               ->함수 개념이 아닌 객체에 소속된 메서드개념.
    *           - 전달되는 함수가 고정되어 있는가? -> 조건에 따라 함수 내용이 다르다.
    *           - 함수 이름이 통일되면서 다른내용을 전달할 수 있는가? -> 오버라이딩(상속,인터페이스)
    *
    * @problem - 사과만 필터링 할 수 있음, 다른 과일-전자제품은 필터링X
    * */
