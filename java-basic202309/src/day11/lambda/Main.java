...
public class Main {
    public static void main(String[] args) {
        ...
        List<Apple> filteredColorApples = FilterApple.filterApplesbyColor(appleBasket, RED);
        for (Apple filteredColorApple : filteredColorApples) {
            System.out.println("filteredColorApple = " + filteredColorApple);
        ...
        System.out.println("== 빨강 또는 노랑 사과만 필터링 ==");
        ...
        System.out.println("== 녹색이면서 100g 이상인 사과들만 필터링 ==");
